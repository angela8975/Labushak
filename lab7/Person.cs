...
namespace lab7
{
    public class Person : IComparable<Person>, ICloneable
    {
        ...
        // Реалізація IComparable<Person> - порівняння за датою народження
        public int CompareTo(Person other)
        {
            if (other == null) return 1;
            return this.bDate.CompareTo(other.bDate);
        }

        // Реалізація ICloneable
        public object Clone()
        {
            return new Person(this.firstName, this.lastName, this.bDate);
        }
    }
}
